...
class GraphAPI(object):
    ...
    def previous(self, response):
        if not self.has_previous(response):
            return {'data' : []}
    ...
    def has_previous(self, response):
        return 'paging' in response and 'previous' in response['paging']

    def has_next(self, response):
        return 'paging' in response and 'next' in response['paging']
